...
The program is also fully functional. It follows a login type program architecture, where upon execution, it prompts the user 
for login information. It follows standard username/password storing practices, salting and hashing, and comparing if supplied passwords
